...
9. Run `fastr-docs doctor .`, the browser E2E suite, and the static export checks before handing off work.
10. Keep strict validation enabled. Opt out only with a documented reason.
